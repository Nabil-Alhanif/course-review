...
<template>
	<div class="bg-white rounded-lg shadow-lg dark:bg-gray-100">
		<div class="p-5 flex">
			...
			<div class="flex">
				<div class="w-3/12"><a href="#">
					<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">{{ review.instructor_name }}</h5>
				</a></div>
			...
			<p class="mb-3 font-normal text-gray-700 dark:text-gray-700">
				the prof is the shit! gotta register asap dude, you wont regret it but idk tho its math
				after all. what do you expect. georngorengoerb er g erg er g er reggerger ertger gergergerg
				ergergerg efrerfwd awefawefwefw fearferf eargferg erferf erfea rfearf aerf aerx
			</p>
